				...
				<form method="POST" action="addnew.php">
					...
					<div class="row">
						...
						<div class="btn-group btn-group-justified" data-toggle="buttons">
							...
							<label class="btn my-btn">
								<input type="radio" id="tricepts" name="exercise" value="Tricepts" /> Tricepts
							</label>
							<label class="btn my-btn">
					...
					<div class="row">
						...
						<div data-toggle="buttons">
							...
							<div class="btn-group2 btn-group-justified">
								<label class="btn my-btn">
									<input type="radio" id="17" name="reps" value="25" /> 25
								</label>
								<label class="btn my-btn">
									<input type="radio" id="18" name="reps" value="26" /> 26
								</label>
								<label class="btn my-btn">
									<input type="radio" id="19" name="reps" value="27" /> 27
								</label>
								<label class="btn my-btn">
									<input type="radio" id="20" name="reps" value="28" /> 28
								</label>
								<label class="btn my-btn">
									<input type="radio" id="21" name="reps" value="29" /> 29
								</label>
								<label class="btn my-btn">
									<input type="radio" id="22" name="reps" value="30" /> 30
								</label>
								<label class="btn my-btn">
									<input type="radio" id="23" name="reps" value="31" /> 31
								</label>
								<label class="btn my-btn">
									<input type="radio" id="24" name="reps" value="32" /> 32
								</label>
							</div>
						</div>
					</div>
